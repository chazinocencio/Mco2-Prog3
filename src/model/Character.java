...
/**
 * Represents a character in the game with type, race, and abilities.
 */
public class Character {
    ...
    private int winCount = 0;
     ...
     /**
     * Constructs a Character with the given attributes.
     *
     * @param name  the character's name
     * @param type  the character type
     * @param ability array of abilities
    ...
    /**
     * Returns all abilities of this character as a string.
     *
     * @return abilities in string form
     */
    ...
    */
    ...
    public void addMaxHP(int amount) {
     ...
     /**
     * Recharges the character's energy by a given amount.
     *
