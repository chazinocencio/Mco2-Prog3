    ...
    */
    ...
    public class Player {
        ...
        /**
         * Returns the player's characters list
         *
        ...
        /**
         * Returns the player's character count
         *
        ...
        /**
         * Displays this player's characters in the specified mode.
         *
        ...
        /**
         * Creates a new character with the given name, type, and abilities, adds it to the roster.
         *
    ...
    // Add this method to remove a magic item by visible index (skipping nulls)
    ...
    // Add a method to get a formatted string of available magic items for GUI
